...
np.savetxt("base_embeddings_test.txt", base_embeddings, fmt="%.6f", delimiter="\t")
...
np.savetxt("lora_embeddings_test.txt", lora_embeddings, fmt="%.6f", delimiter="\t")
...
base_embeddings = np.loadtxt("base_embeddings_test.txt", delimiter="\t")
lora_embeddings = np.loadtxt("lora_embeddings_test.txt", delimiter="\t")
